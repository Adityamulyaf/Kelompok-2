...
# Fungsi untuk menambahkan waypoint terakhir
...
# Fungsi untuk mengontrol gerakan kapal
def gerak(vx, vy):
...
if __name__ == "__main__":
    ...
    # Buka video streaming atau kamera
    cap = cv2.VideoCapture('WhatsApp Video 2024-11-25 at 23.04.23_1d042ebe.mp4')  # Ganti dengan file video jika perlu
