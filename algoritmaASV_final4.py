...
def baca_grid(frame):
    ...
    while cap.isOpened():
        ...
        video_width = 540  # Ganti dengan lebar yang diinginkan
        video_height = 380  # Ganti dengan tinggi yang diinginkan
        ...
        if detected_green_grids == {6} and detected_red_grids == {4}:
            ...
            gerak(0.7, -0.3)  # Belok kiri 20 derajat
            print("Kiri 20")
        elif detected_red_grids == {4} and not detected_green_grids:
            gerak(0.7, 0.3)  # Belok kanan 20 derajat
            print("Kanan 20")
        else:
